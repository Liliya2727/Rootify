...
class _RootStatusPill extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // --- Detail: Status Icons
    final lucideIcons = [
      const IconData(0xe9b2, fontFamily: 'LucideIcons'), // checkCircle2
      const IconData(0xeab6, fontFamily: 'LucideIcons'), // xCircle
    ];
      ...
      data: (status) {
        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              Icon(isGranted ? lucideIcons[0] : lucideIcons[1],
                  size: 12, color: color),
...
class _ErrorState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final alertCircle = const IconData(0xe90b, fontFamily: 'LucideIcons');
    ...
    return Center(
      child: Container(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(alertCircle, color: errorColor, size: 32),
            const SizedBox(height: 8),
